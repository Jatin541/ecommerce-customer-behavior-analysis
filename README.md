...
This project originated as a team assignment in the Data Analytics for Business program at St. Clair College.
The original team included Jatin Saini, Asbin Ghimire, and Chetan Jivanbhai Yadav.

This repository is a portfolio refresh curated by Jatin Saini. The code structure, documentation, and presentation
have been reorganized for recruiter-facing use. Original team credit is retained, and student ID numbers have been removed.
